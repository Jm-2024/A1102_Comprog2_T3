...
public class Logins extends JFrame {
    ...
    private void viewEmployee() {
        if (selectedRow != -1) {
            String userr = model.getValueAt(selectedRow, 0).toString();
            String pasw = model.getValueAt(selectedRow, 1).toString();
            String names = model.getValueAt(selectedRow, 2).toString();
            ...
            detailsFrame.add(new JLabel("Username:"));
            JTextField user = new JTextField(userr);
            user.setEditable(false);
            detailsFrame.add(user);

            detailsFrame.add(new JLabel("Password:"));
            JTextField pass = new JTextField(pasw);
            pass.setEditable(false);
            detailsFrame.add(pass);
