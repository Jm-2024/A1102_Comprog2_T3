...
public class fileleave extends JFrame {
    private JTextField empNumField, lastNameField, firstNameField, reasonfield, remarks;
    ...
    public fileleave() {
        ...
        // Create column names
        String[] columns = {"Employee Number", "Last Name", "First Name", "Reason", "Remarks"};
        ...
        table.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    remarks.setText(model.getValueAt(selectedRow, 4).toString());
        ...
        fieldsPanel.add(new JLabel("Remarks:"));
        fieldsPanel.add(remarks);
    ...
    private void addRow() {
        ...
        if (!empNum.isEmpty() && !lastName.isEmpty() && !firstName.isEmpty() && !reas.isEmpty() && !rem.isEmpty()) {
            model.addRow(new Object[]{empNum, lastName, firstName, reas, rem });
            saveCSV();
            clearFields();
    ...
    private void updateRow() {
        if (selectedRow != -1) {
            ...
            if (!empNum.isEmpty() && !lastName.isEmpty() && !firstName.isEmpty() && !reas.isEmpty() && !rem.isEmpty()) {
                ...
                model.setValueAt(rem, selectedRow, 4);
    ...
    private void initializeCSV() {
        ...
        if (!file.exists()) {
            try (CSVWriter writer = new CSVWriter(new FileWriter(CSV_FILE))) {
                String[] header = {"Employee Number", "Last Name", "First Name", "Reason", "Remarks"};
